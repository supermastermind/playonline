...
let precalculated_games_5columns_1st_level = new Array(nbMaxColumns);
for (let i = 0; i < nbMaxColumns; i++) {
  precalculated_games_5columns_1st_level[i] = new Array(nbMaxColumns);
}
